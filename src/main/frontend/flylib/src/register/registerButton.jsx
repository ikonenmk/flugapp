...
export default function RegisterButton({emailError, passError, dataBaseError, usernameError, handleSubmit}) {

    if (emailError || passError || dataBaseError || usernameError) {
